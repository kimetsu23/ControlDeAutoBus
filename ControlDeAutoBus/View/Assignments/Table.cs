...
namespace ControlDeAutoBus.View.Assignments
{
    public partial class Table : Form
    {
        ...
        private void LoadSampleData()
        {
            ...
            tableGrid.Columns.Add("Auto Bus", "Auto Bus");
            tableGrid.Columns.Add("Ruta", "Ruta");
            tableGrid.Columns.Add("Activo", "Activo");
            tableGrid.Columns.Add("Fecha de asignacion", "Fecha de asignacion");
