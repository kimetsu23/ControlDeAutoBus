...
namespace ControlDeAutoBus.View.Settings
{
    public partial class FormSettings : Form
    {
        ...
        {
            IconEye.IconColor = Color.FromArgb(33, 37, 41); // Gris más oscuro al hover
        }

        private void IconEye_MouseLeave(object sender, EventArgs e)
        {
            IconEye.IconColor = Color.FromArgb(108, 117, 125); // Volver al gris normal
        }
        ...
        private void BtnVerClave_Click(object sender, EventArgs e)
        {
            if (txtClave.UseSystemPasswordChar)
            {
                ...
                IconEye.IconChar = FontAwesome.Sharp.IconChar.EyeSlash; // Cambiar a ojo tachado
                IconEye.IconColor = Color.FromArgb(13, 110, 253); // Azul cuando está visible
            }
            else
            {
                // Ocultar contraseña
                txtClave.UseSystemPasswordChar = true;
                IconEye.IconChar = FontAwesome.Sharp.IconChar.Eye; // Volver a ojo normal
                IconEye.IconColor = Color.FromArgb(108, 117, 125); // Volver a gris
            }
        }
    }
}